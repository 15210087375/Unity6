    ...
    public class CustomButtonEditor : UnityEditor.UI.ButtonEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_showPress)
            {
                ...
                _longPressTimeProperty.floatValue =
                    EditorGUILayout.FloatField("按下多久算长按", _longPressTimeProperty.floatValue);
                _doClickAndLongPressProperty.boolValue =
                    EditorGUILayout.Toggle("同时触发点击和长按", _doClickAndLongPressProperty.boolValue);
                EditorGUILayout.Space();
