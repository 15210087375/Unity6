...
namespace xasset.editor
{
    public class Builder : IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        public static void BuildPlayer1(string outputPath)
        {
            ...
            // string outputPath = "C:/Builds/Windows/";
            ...
            // Build the player with the specified output path
            BuildPipeline.BuildPlayer(levels.ToArray(), outputPath, BuildTarget.StandaloneWindows64, BuildOptions.None);
