...
namespace xasset
{
    ...
    {
        public static readonly Queue<AssetRequest> Unused = new Queue<AssetRequest>();
        public static readonly Dictionary<string, AssetRequest> Loaded = new Dictionary<string, AssetRequest>();
